  ...
  <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
		      <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" action="/vip/vipSava" method="post">
                                 <input type="hidden" name="id" value="${entity.id}">
                                <div class="form-group">
                                     <label class="col-lg-2 control-label">VIP名称</label>
                                     <div class="col-lg-3">
                                      <input type="text" class="form-control" name="levelName" value="${entity.levelName}"> 
                                     </div>
                                </div>
                                <div class="form-group">
